# Copyright (C) 2018-2019 The Project-Xtended
#
...
KERNEL_MAKE_FLAGS += -j$(shell prebuilts/tools-xtended/$(HOST_PREBUILT_TAG)/bin/nproc --all)
...
TOOLS_PATH_OVERRIDE := \
    LD_LIBRARY_PATH=$(BUILD_TOP)/prebuilts/tools-xtended/$(HOST_PREBUILT_TAG)/lib:$$LD_LIBRARY_PATH \
...
ifeq ($(KERNEL_ARCH),arm64)
  ...
  TOOLS_PATH_OVERRIDE += PATH=$(BUILD_TOP)/prebuilts/tools-xtended/$(HOST_PREBUILT_TAG)/bin:$(KERNEL_TOOLCHAIN_arm):$$PATH
else
  TOOLS_PATH_OVERRIDE += PATH=$(BUILD_TOP)/prebuilts/tools-xtended/$(HOST_PREBUILT_TAG)/bin:$$PATH
endif
